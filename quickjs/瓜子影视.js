...
var rule = {
    ...
    lazy: $js.toString(() => {
        ...
        var html = fetch('https://api.9cec79d.com/App/Resource/VurlDetail/showOne', {
            headers: {
    ...
    一级: $js.toString(() => {
        ...
        var html2 = gethtml("https://api.9cec79d.com/App/IndexList/indexList", body, headers)
    ...
    二级: $js.toString(() => {
        ...
        input = input.replace('https://api.9cec79d.com/', '');
        ...
        var html = gethtml("https://api.9cec79d.com/App/IndexPlay/playInfo", body, headers)
        ...
        var html3 = gethtml("https://api.9cec79d.com/App/Resource/Vurl/show", body2, headers); //log(html3)
